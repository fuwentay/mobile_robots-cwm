...
const unsigned char wfb[16] = {11,0,7,5,12,13,15,0,15,12,14,15,11,7,15,14};
...
//  LCD->WF8B[37] = 0b1110;   // Waveform register for pin 5 of the LCD
//  LCD->WF8B[17] = 0b0110;   // Waveform register for pin 6 of the LCD
